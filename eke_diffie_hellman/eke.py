...
class DiffieHellman:
    ...
    def get_AES_key(self):
        # key derivation function(KDF) used to derive 128 bit AES key
    ...
    def encrypt(self, secret_key_bytes, encryption_bytes):
        # encrypt given message using given key with AES in CBC mode
    ...
    @staticmethod
    def get_DH_params():
        # This is for shortcut. Parameter generation can take arbitrary amount of time.
        ...
        # Actual method for generating the modulus and generator
        while True:
            q = getPrime(2048)
